<?php
	...
	Class Thread {
		private $password = 'fad5534fdas31sgol'; //change this
		private $salt = '9DdfEQfn8*#^2n!9sjErF'; //and this
		private $max_threads = 10; //max synchronous requests, try more or less
