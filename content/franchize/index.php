...
// --------Получаем контент для блока "Что такое франшиза?"--------
$arSelect = Array("ID", "NAME", "PREVIEW_PICTURE", "PREVIEW_TEXT");
$arFilter = array("IBLOCK_ID" => 39);
$what_franch_res = CIBlockElement::GetList(Array(), $arFilter, false, Array("nPageSize"=>1), $arSelect);
while($ob = $what_franch_res->GetNextElement())	$what_franch = $ob->GetFields();
?>
	...
	<div class="container">
		<div class="row ">
			<div class="col-md-12">
				...
				<a href="#" class="what" data-toggle="modal" data-target="#what_franchise">Что такое франшиза?</a>
			</div>
		</div>
	</div>
</div>
<div class="modal fade" id="franchform" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	<div class="modal fade" id="what_franchise" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="myModalLabel"><?=$what_franch['NAME']?></h4>
				</div>
				<div class="modal-body">
					<?=$what_franch['PREVIEW_TEXT']?>
				</div>
			</div>
		</div>
	</div>
