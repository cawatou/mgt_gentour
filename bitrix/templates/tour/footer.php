        ...
        <div class="modal-content">
            ...
            <form id="addRewv" enctype="multipart/form-data">
                <div class="modal-body">
                    <? if (!in_array(1, $USER->GetUserGroupArray()) && !in_array(5, $USER->GetUserGroupArray()) && !in_array(10, $USER->GetUserGroupArray())) { ?>
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="form-group ">
                                    <input name="phone" class="phone-number-for-mask form-control" placeholder="Телефон"
                                           required/>
                                </div>
                                <div class="form-group ">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <a href="#" class="redbot loadpic">Добавьте ваше фото кликнув сюда</a> <span
                                    id="fileformlabel"></span>
                            </div>
                        </div>
                    <?
                    } else {
                    ...
                    <div class="row">
                        <div style="position: relative;" class="col-md-12 col-xs-12">
                            <textarea name="more" required class="form-control" style="min-height: 250px"
                                      placeholder="Ваш Отзыв (не более 500 символов)"></textarea>
...
<div class="modal fade" id="question_franchise" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <? $APPLICATION->IncludeComponent("bitrix:form.result.new", "question_franchise", Array(
                    "SEF_MODE" => "N",
                    "WEB_FORM_ID" => 11,
                    "EDIT_URL" => "",
                    "CHAIN_ITEM_TEXT" => "",
...
<script>
    ...
    var inGroup = <? if(in_array(1, $USER->GetUserGroupArray()) || in_array(10, $USER->GetUserGroupArray())){?>"y";
    <?}else{?>"n";<?}?>
